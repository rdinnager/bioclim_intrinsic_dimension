...
bioclim_files <- list.files("data/bioclim_5", full.names = TRUE)
...
write_rds(scaling, "data/bioclim_scaling_5.rds")
...
torch_save(vae, "data/trained_vae_1_5.to")

############### figures for VAE #####################

vae <- torch_load("data/trained_vae_1_5.to")
vae <- vae$cuda()
...
write_rds(non_manifold_dim_nums, "data/non_manifold_dim_nums_5.rds")
...
write_csv(bioclim_df, "data/vae_manifold_vars_5.csv")
...
writeRaster(vae_rast, c("data/bioclim_manifold_5m_1.tif",
...
writeRaster(pca_rast[[1:10]], "data/bioclim_pca_10_5m.tif")
...
writeRaster(mani_ecoreg, "data/bioclim_manifold_all_data_5.tif")
writeRaster(bioclim_scaled_rast, "data/bioclim_scaled_5.tif")
