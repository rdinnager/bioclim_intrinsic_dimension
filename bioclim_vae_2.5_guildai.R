...
write_rds(scaling, "bioclim_scaling.rds")
...
torch_save(vae, "trained_vae_1.to")
...
write_rds(non_manifold_dim_nums, "non_manifold_dim_nums.rds")
...
write_csv(bioclim_df, "vae_manifold_vars.csv")
...
writeRaster(vae_rast, c("bioclim_manifold_1.tif",
                        "bioclim_manifold_2.tif",
                        "bioclim_manifold_3.tif",
                        "bioclim_manifold_4.tif",
                        "bioclim_manifold_5.tif"),
            overwrite = TRUE)
